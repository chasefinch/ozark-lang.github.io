          ...
          <div class='col-md-10 col-md-offset-1'>
            ...
            <div class='row'>
              <div class='col-sm-6'>
                ...
                <p>Regardless of where it came from or where it's been edited, a set of Ozark files serves as both a codebase and a save format for advanced IDEs.
                <h4>Q. Why can't I use variables like I'm used to?</h4>
                <p><strong>A.</strong> Ozark uses variables as properties of objects, and to connect the inputs and outputs of methods. In most cases, they are meant to be temporary and unchanging.</p>
                <p>Like in flow-based programming, the programmer focuses on the flow of data instead of temporary states. The state is nicely contained within the properties of the objects themselves.</p>
              </div>
              <div class='col-sm-6'>
