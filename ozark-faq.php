          ...
          <div class='col-md-10 col-md-offset-1'>
            ...
            <div class='row'>
              ...
              <div class='col-sm-6'>
                ...
                <p><strong>A.</strong> "Pure" object-oriented programming languages always seems to let a sneaky bit of procedural programming called "self" (or "this") hang around. An object needs total access to it's properties, but it doesn't need access to procedurally run it's own methods. See <a target="_blank" href='https://r.je/this-keyword-isnt-oop.html'>this article</a> for a great description of the issue.</p>
