...
method processScene
	...
	@scene update</pre></div>
								...
								<p>In Ozark, everything is an object. But <em>values</em> (such as the number <code>5.3</code>, the list <code>[3, 4, 9]</code> or the string <code>Cheese</code>) are not <em>things</em>; they are attributes that we use to describe things. Therefore, they are not represented as objects, and they can be manipulated by stateless functions. Ozark handles this very elegantly.</p>
							</div>
							<div class='col-sm-6'>
