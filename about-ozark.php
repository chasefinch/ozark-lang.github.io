					...
					<div class='col-md-10 col-md-offset-1'>
						<div class='row'>
							<div class='col-sm-9'>
								...
								<p class='lead'>Currently, Ozark is a prototype language and neither of these options are available. You can find information about contributing to the project here:</p>
