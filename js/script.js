var reserved = ["&lt;-", "class", "clear", "create", "enumeration", "else", "extension", "for", "identify", "if", "inheritance", "method", "property", "repeat", "requirement", "set", "state", "type", "unless", "until", "while", "with", "without"];
var symbols = ["+", "-", "&gt;", "&lt;", "≥", "≤", "^", "¬", "*", "÷", "√", "∫", "∑", "=", "≠"];
