...
<html lang="en">
  <?php
    $title = "Ozark Language - Contribute";
    $description = "Contribute to Ozark, the strict, elegant, open-source programming language.";
  ...
  <body>
    <section class="ribbon">
  	...
  	<header>
        ...
        <div class='row'>
          <div class='col-md-10 col-md-offset-1'>
            <?php $active = 'contribute'; require('includes/nav.php'); ?>
          </div>
        </div>
	    </div>
  	</header>
