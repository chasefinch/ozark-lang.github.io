...
<html lang="en">
  <?php
    $title = "Ozark Language - Documentation - Data Types - Classes";
    $description = "Classes in Ozark, the strict, elegant, open-source programming language.";
          ...
          <div class='col-md-10 col-md-offset-1'>
            <div class='row'>
              <div class='col-sm-3 hidden-xs'>
                <?php $submenu = 'data-types'; $subpage = 'classes'; require('../../includes/documentation-nav.php'); ?>
              </div>
              <div class='col-sm-9'>
                <div class='row'>
                  <div class='col-sm-8'>
