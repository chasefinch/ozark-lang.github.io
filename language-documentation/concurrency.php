...
<html lang="en">
	<?php
		$title = "Ozark Language - Documentation - Localization";
					...
					<div class='col-md-10 col-md-offset-1'>
						<div class='row'>
							...
							<div class='col-sm-9'>
								<div class='row'>
									<div class='col-sm-7'>
										<h1 class='main-heading' id="overview">Concurrency</h1>
									</div>
									<div class='col-sm-5'>
									...
									<div class='col-lg-10'>
										<main>
											<div class='alert alert-warning'>
												<p><span class='glyphicon glyphicon-alert'></span> <strong>Notice:</strong> This feature will be available in a future version of Ozark.</p>
											</div>
